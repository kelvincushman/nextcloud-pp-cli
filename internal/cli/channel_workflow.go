...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  nextcloud-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  nextcloud-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"index-php", "index-php-apps-deck-api-v1-0-boards", "ocs", "ocs-v2-php-apps-activity-api-v2-activity-filter", "ocs-v2-php-apps-files-sharing-api-v1-shares", "ocs-v2-php-apps-notifications-api-v2-notifications", "ocs-v2-php-apps-spreed-api-v4-room", "ocs-v2-php-apps-user-status-api-v1-statuses", "ocs-v2-php-apps-user-status-api-v1-user-status", "ocs-v2-php-cloud-capabilities", "ocs-v2-php-cloud-groups"}
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  nextcloud-pp-cli workflow status

  # Show status as JSON
  nextcloud-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("nextcloud-pp-cli")
			}
