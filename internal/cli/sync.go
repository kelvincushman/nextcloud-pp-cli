...
Resource scoping:
  ...
  nextcloud-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  nextcloud-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  nextcloud-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  nextcloud-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  nextcloud-pp-cli sync --latest-only`,
...
func syncResourceSinceParam(resource string) string {
	switch resource {
	case "ocs-v2-php-apps-activity-api-v2-activity-filter":
		return "since"
	}
	return ""
}
...
func defaultSyncResources() []string {
	return []string{
		...
		"ocs-v2-php-apps-files-sharing-api-v1-shares",
		"ocs-v2-php-apps-notifications-api-v2-notifications",
		"ocs-v2-php-apps-spreed-api-v4-room",
		"ocs-v2-php-apps-user-status-api-v1-statuses",
		"ocs-v2-php-apps-user-status-api-v1-user-status",
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"index-php":                           "/index.php/apps/notes/api/v1/notes",
		"index-php-apps-deck-api-v1-0-boards": "/index.php/apps/deck/api/v1.0/boards",
		"ocs":                                 "/ocs/v2.php/cloud/users",
		"ocs-v2-php-apps-activity-api-v2-activity-filter":    "/ocs/v2.php/apps/activity/api/v2/activity/filter",
		"ocs-v2-php-apps-files-sharing-api-v1-shares":        "/ocs/v2.php/apps/files_sharing/api/v1/shares",
		"ocs-v2-php-apps-notifications-api-v2-notifications": "/ocs/v2.php/apps/notifications/api/v2/notifications",
		"ocs-v2-php-apps-spreed-api-v4-room":                 "/ocs/v2.php/apps/spreed/api/v4/room",
		"ocs-v2-php-apps-user-status-api-v1-statuses":        "/ocs/v2.php/apps/user_status/api/v1/statuses",
		"ocs-v2-php-apps-user-status-api-v1-user-status":     "/ocs/v2.php/apps/user_status/api/v1/user_status",
		"ocs-v2-php-cloud-capabilities":                      "/ocs/v2.php/cloud/capabilities",
		"ocs-v2-php-cloud-groups":                            "/ocs/v2.php/cloud/groups",
	}
