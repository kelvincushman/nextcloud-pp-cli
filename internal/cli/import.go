...
but do not stop the import.`,
  ...
  nextcloud-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  nextcloud-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | nextcloud-pp-cli import <resource> --input -`,
