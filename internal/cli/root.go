...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "nextcloud-pp-cli",
		Short: "Manage nextcloud resources via the nextcloud API",
		Long: `Manage nextcloud resources via the nextcloud API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'nextcloud-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("nextcloud-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'nextcloud-pp-cli profile list')")
	...
	rootCmd.AddCommand(newIndexPhpCmd(flags))
	rootCmd.AddCommand(newOcsCmd(flags))
	rootCmd.AddCommand(newRemotePhpCmd(flags))
	...
	rootCmd.AddCommand(newStorageSummaryCmd(flags))
	rootCmd.AddCommand(newSharesStaleCmd(flags))
	rootCmd.AddCommand(newAccessTreeCmd(flags))
	rootCmd.AddCommand(newDigestCmd(flags))
	rootCmd.AddCommand(newQuotaCheckCmd(flags))
	rootCmd.AddCommand(newSyncStatusCmd(flags))
	rootCmd.AddCommand(newNextcloudContextCmd(flags))
